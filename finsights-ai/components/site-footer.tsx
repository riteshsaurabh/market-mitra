        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          <div className="col-span-2 md:col-span-1">
            ...
            <p className="text-sm text-muted-foreground mb-4">
              AI-powered financial insights generator for stock market traders and analysts.
            </p>
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground mb-4">Stay updated with the latest features and releases.</p>
            <div className="flex flex-col sm:flex-row gap-2">
              <Input placeholder="Enter your email" className="max-w-full" />
